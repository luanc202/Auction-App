...
RSpec.describe AuctionBatch, type: :model do
  describe '#valid?' do
    it 'código deve ser válido' do
      user = User.create!(email: 'julia@leilaodogalpao.com.br', password: '@#$GBRD', name: 'Julia', cpf: '04206205086')
      auction_batch = AuctionBatch.new(code: 'AAAB23', start_date: 1.day.from_now, end_date: 7.days.from_now,
    ...
    it 'código é obrigatório' do
      user = User.create!(email: 'julia@leilaodogalpao.com.br', password: '@#$GBRD', name: 'Julia', cpf: '04206205086')
      auction_batch = AuctionBatch.new(code: '', start_date: 1.day.from_now, end_date: 7.days.from_now,
                                       minimum_bid_amount: 300, minimum_bid_difference: 10, created_by_user_id: user.id)
    ...
    it 'start_date é obrigatório' do
      user = User.create!(email: 'julia@leilaodogalpao.com.br', password: '@#$GBRD', name: 'Julia', cpf: '04206205086')
      auction_batch = AuctionBatch.new(code: 'ABC123', start_date: '', end_date: 7.days.from_now,
                                       minimum_bid_amount: 300, minimum_bid_difference: 10, created_by_user_id: user.id)
    ...
    it 'end_date é obrigatório' do
      user = User.create!(email: 'julia@leilaodogalpao.com.br', password: '@#$GBRD', name: 'Julia', cpf: '04206205086')
      auction_batch = AuctionBatch.new(code: 'ABC123', start_date: 1.day.from_now, end_date: '',
                                       minimum_bid_amount: 300, minimum_bid_difference: 10, created_by_user_id: user.id)
    ...
    it 'minimum_bid_amount é obrigatório' do
      user = User.create!(email: 'julia@leilaodogalpao.com.br', password: '@#$GBRD', name: 'Julia', cpf: '04206205086')
      auction_batch = AuctionBatch.new(code: 'ABC123', start_date: 1.day.from_now, end_date: 7.days.from_now,
    ...
    it 'start_date deve ser pelo menos 1h no futuro' do
      user = User.create!(email: 'julia@leilaodogalpao.com.br', password: '@#$GBRD', name: 'Julia', cpf: '04206205086')
      auction_batch = AuctionBatch.new(code: 'ABC123', start_date: 30.minutes.from_now, end_date: 7.days.from_now,
                                       minimum_bid_amount: 300, minimum_bid_difference: 10, created_by_user_id: user.id)
    ...
    it 'end_date deve ser pelo menos 12h no futuro' do
      user = User.create!(email: 'julia@leilaodogalpao.com.br', password: '@#$GBRD', name: 'Julia', cpf: '04206205086')
      auction_batch = AuctionBatch.new(code: 'ABC123', start_date: 65.minutes.from_now, end_date: 6.hours.from_now,
                                       minimum_bid_amount: 300, minimum_bid_difference: 10, created_by_user_id: user.id)
