...
bid = Bid.create!(batch_id: batch.id, user_id: guest_user.id, value: 220)
...
reply = AuctionQuestionReply.create!(user:, auction_question: batch.auction_questions.first,
...
user_fav_batch = UserFavBatch.create!(user: guest_user, batch:)
